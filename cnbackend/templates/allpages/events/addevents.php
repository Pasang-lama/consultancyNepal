            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="database/actions/events/insert.php" class="cmxform" enctype="multipart/form-data"
                            ...
                            <fieldset>
                                <div class="row">
                                    <div class="form-group col-6"><label for="firstname">Title</label> <input
                                            class="form-control titl" name="title" id="firstname" data-tb="events" >
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="card-title d-flex">Image <small
                                                    ...
                                                    class="dropify" name="eventimage" type="file">
                                            </div>
                                        </div>
                                    </div>
