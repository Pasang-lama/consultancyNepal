            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?=base_url("action/consultancy/insertsucessgallery.php")?>" class="cmxform"
                            ...
                            <fieldset>
                                ...
                                <section class="SucessGalleryData">
                                    <div class="row">
                                        <div class="form-group col-4">
                                            ...
                                            <input
                                            type="text"
                                                class="form-control" name="name[]" id="firstname" required>
                                        </div>
                                            <div class="form-group col-4">
                                ...
                                <input class="btn btn-primary"
                                        name="addmember" type="submit" value="+addGallery">
                            </fieldset>
                        </form>
                    </div>
                </div>
