...
<?php $id=$_GET["id"];$admindata=$db->CustomQuery("SELECT * FROM test_preparation WHERE id='$id'");foreach($admindata as $data): ?>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?=$base_url?>database/actions/test-preparation/edit.php" class="cmxform"
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="card-title d-flex">Image <small
                                                    ...
                                                    name="testprep_image" class="dropify" type="file">
                                            </div>
                                        </div>
                                    </div>
