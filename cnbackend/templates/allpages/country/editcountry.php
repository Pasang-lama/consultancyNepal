            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?= $base_url ?>database/actions/country/edit.php" class="cmxform"
                            ...
                            <fieldset><input name="id" value="<?= $id ?>" type="number" hidden>
                                <div class="row">
                                    <div class="form-group col-6"><label for="firstname">Title</label> <input
                                            name="country_name" value="<?= $data->country_name ?>" class="form-control"
                                            id="firstname"></div>
                                ...
                                <div class="row">
                                    <div class="form-group col-6"><label for="firstname">Slug</label> <input name="slug"
                                            value="<?= $data->country_slug ?>" class="form-control" id="firstname">
                                    </div>
                                    ...
                                    <div class="mt-3 col-lg-4 grid-margin stretch-card">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <input name="countryimage" class="dropify" type="file">
                                            </div>
                                        </div>
                                    </div>
    ...
    <?php
                                    ...
                                    <div class="form-group col-12">
                                        <label for="firstname">Intro Text</label> <textarea class="form-control"
                                            ...
                                            wt-ignore-input="true"><?= $data->intro_text ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group col-12"><label for="firstname">Details</label> <textarea
                                        ...
                                        style="resize:none" wt-ignore-input="true"><?= $data->description ?></textarea>
                                </div>
                    </div>
