...
<div class="main-panel">
    <div class="content-wrapper"> <div class="page-header">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Show SucessGallery</h4>
                <div class="row">
                    <div class="col-12">
                            ...
                            <table class="table" id="order-listing">
                                ...
                                <tbody><?php foreach($gallery as $key=>$data){ ?><tr>
                                        ...
                                        <td>
                                            ...
                                            if(!empty($data->image)){
                                                ?>
                                                <img alt="error" height="100px"
                                                src="https://www.consultancynepal.com/cnbackend/public/<?=$data->image?>"
                                                width="100%">
                                            <?php
                                            }
                                            else{
                                        ...
                                        <td>
                                            <a href="<?=base_url("consultancy/editsucessg.php?id=$data->g_id")?>"
