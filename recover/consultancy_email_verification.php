        ...
        if(!is_numeric($_POST["code"])){
          ...
          if(!array_filter($errors)){
              ...
              if($count>0){
                ...
                $_SESSION["isvirify"] = "yess";
                
                echo '<script type="text/javascript">';
                echo 'window.location.href="https://www.consultancynepal.com/consultancyregistraion";';
                echo '</script>';
                die();
                  ...
                  $errors["code"]="Code not Match";
                                        ...
                                        echo $_SESSION["verify_email"];
                                        echo $_SESSION["verify_name"];
                                        echo $_SESSION["verify_username"];
                                        echo $_SESSION["verify_gender"];
                                        echo  $_SESSION["verify_password"];
?>
<!DOCTYPE html>
    <html lang="en">
    <head>
