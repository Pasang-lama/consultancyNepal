        ...
        <ul class="nav"> 
            ...
            <li class="nav-item">
                ...
                <a class="nav-link" data-toggle="collapse" href="#ui-basics" aria-expanded="false" aria-controls="ui-basic">
                    ...
                    <span class="menu-title">Call Enquiry</span>
                    <i class="menu-arrow"></i>
                </a>
                <div class="collapse" id="ui-basics">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="<?=$base_url?>showenquiry">Show Enquiry</a></li>
                    </ul>
                </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#rank" aria-expanded="false" aria-controls="form-elements">
              <i class="fa-sharp fa-solid fa-address-card"></i>&nbsp;&nbsp;&nbsp;
                <span class="menu-title">Rank Item</span>
              <i class="menu-arrow"></i>
              </a>
              <div class="collapse" id="rank">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"><a class="nav-link" href="<?=$base_url?>rankconsultancy">Rank Consultancy</a></li>                
                  <li class="nav-item"><a class="nav-link" href="<?=$base_url?>rankcountry">Rank Country</a></li>  
                </ul>
              </div>
            </li>
                       <li class="nav-item">
