            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a class="link"
                            href="<?= $base_url ?>showcontent">Display Content</a></li>
                </ol>
            </nav>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="database/actions/content/insert.php" class="cmxform" enctype="multipart/form-data"
                            ...
                            <fieldset>
                                <div class="row">
                                    <div class="form-group col-6"><label for="firstname">Title</label> <input
                                            class="form-control titl" name="title" class="ckt" id="tit" data-tb="contents" >
                                            <div id="content-title-check" style="display:none;width:400px;height:200px;overflow:scroll;background-color:pink;">
                                                
                                            </div>
                                            </div>
                                    <div class="form-group col-6 mt-3"><label for="firstname">Date</label> <input
                                            class="form-control" name="date" type="date"></div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="card-title d-flex">Image <small
                                                    ...
                                                    class="dropify" name="contentimage" type="file">
                                            </div>
                                        </div>
                                    </div>
