...
<?php $id=$_GET["id"];$contentdata=$db->CustomQuery("SELECT * FROM contents WHERE id='$id'");foreach($contentdata as $data): ?>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?=$base_url?>database/actions/content/edit.php" class="cmxform"
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="card-title d-flex">Image <small
                                                    ...
                                                    name="contentimage" class="dropify" type="file">
                                            </div>
                                        </div>
                                    </div>
