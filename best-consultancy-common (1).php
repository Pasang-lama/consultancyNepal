...
$blogData=$db->CustomQuery("SELECT * FROM `$url[1]`  where status=1 order by id desc"); 
$datas=$blogData;
    $title=ucwords(str_replace('-', ' ', $url[1]));
...
?>
  <!-- banner & breadcrum start -->
    <section class="banner position-relative">
        <div class="black"></div>
         <!--<img src="assets/images/aus.jpg" width="100%" alt="">-->
    ...
    </section><!-- banner & breadcrum close -->
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content bg-white border-none">
          ...
          <div class="ratio ratio-16x9 bg-dark rounded overflow-hidden">
            <iframe src="https://www.youtube.com/embed/TjszbFXbTbo"
