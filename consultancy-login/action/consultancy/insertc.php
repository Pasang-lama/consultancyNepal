...
$old=[];
if(!empty($_POST)){
    $skiped_data=["status","introtextckediter","detailckediter","video","img_url"];
    ...
    if(array_key_exists("username",$_POST))
     ...
     if(!empty($errors)){
        ...
        $_SESSION["old"]=$old;
         ...
         echo 'window.location.href="https://www.consultancynepal.com/consultancy-login/consultancy/addclasses";';
         echo "</script>";
        die();
 ...
 if (
     ...
     header("location:https://www.consultancynepal.com/consultancy-login/consultancy/addclasses");
 }
  ?>