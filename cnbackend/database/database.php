...
class Database
{
    ...
    {
        try {
            $this->_connection = new PDO("mysql:host=localhost;dbname=consulta_consultancynepal", "root", "Root@1234");
    ...
    {
        if (empty($tableName) || empty($tableName) || empty($criteria) || empty($bindValue)) throw new PDOException("Criteria not match");
