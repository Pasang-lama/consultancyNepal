<?php include "layouts/header.php";include "layouts/aside.php";require_once "database/database.php";require_once "database/tables.php";$db=Database::Instance(); ?><?php 
$admindata=$db->CustomQuery("SELECT * FROM `area` ORDER BY `area`.`id` DESC
"); ?>
    ...
    <div class="content-wrapper"><?php include("infos/message.php") ?><div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="<?=$base_url?>addarea"
                            class="link">Add area</a></li>
                </ol>
            </nav>
        </div>
        <div class="card">
                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <table class="table" id="order-listing">
                                ...
                                <tbody><?php $key=1; foreach($admindata as $data): ?><tr>
                                        <td><?=$key++?></td>
                                        <td><?=$data->area?></td>
                                        <td><a href="<?=$base_url?>templates/allpages/places/edit_area.php?id=<?=$data->id?>"
                                                class="link edit-admin" data-eid="<?=$data->id?>"><button
                                                    class="btn btn-outline-primary"><i
                                                        class="fa-solid fa-pen-to-square fa-sharp"></i></button></a> <a
                                                href="#" class="link btn btn-outline-primary delete-area"
