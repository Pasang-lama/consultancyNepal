...
?><div class="main-panel">
      <div class="content-wrapper"><?php include "../../../infos/message.php"; ?>
          <div class="page-header">
              <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                      <li class="breadcrumb-item"><a class="link"
                              href="<?= $base_url ?>addconsultancy">AddConsultancy</a></li>
 ...
 ?>
                          ...
                          <form action="<?= $base_url ?>database/actions/consultancy/addcountry.php" method="post"
                              enctype="multipart/form-data">
                              <div class="row d-flex flex-row-reverse">
                                  <div class="col-2 fixed-top"
                                      style="position:fixed;top:190px;right:0;z-index:1030;left:inherit"><input
                                          type="submit" value="Submit" class="btn btn-primary mt-5 submitcheck">
                                  </div>
...
?>
                                    ...
                                    <a class="btn btn-primary mx-2" href="<?=$base_url?>templates/allpages/consultancy/sucessgallery.php?co_id=<?=$list->id;?>&c_id=<?=$cid?>">addsucessgallery</a>
                                                  <?php
}
?>
                                              </td>
...
?>
                                                  <!-- <input name="sucessgalleryimage[]" multiple type="file"> -->
                                    <a class="btn btn-primary mx-2" href="<?=$base_url?>templates/allpages/consultancy/viewsucessgallery.php?id=<?=$list->id?>">Viewsucessgallery</a>
                                                  <?php
}
?>
                                              </td>
